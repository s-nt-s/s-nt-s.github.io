Title: OpenWrt en Nexx WT3020F
Category: Sistemas
Tags: OpenWrt, Nexx WT3020F, !css, !python, !aircrack
body_class: ulcompact
SOURCE: https://github.com/s-nt-s/OpenWrt-Nexx_WT3020F/blob/master/README.md
footer: <hr/>\n\nRepositorio con todo el código en [github.com/s-nt-s](https://github.com/s-nt-s/OpenWrt-Nexx_WT3020F)
...
o lo que es lo mismo, pero automatizado, [`./dwn_build.sh`](https://github.com/s-nt-s/OpenWrt-Nexx_WT3020F/raw/master/dwn_build.sh)
...
Ver [`files` del repositorio](https://github.com/s-nt-s/OpenWrt-Nexx_WT3020F/raw/master/files/) para observar el resultado final.
...
Para no tener que escribir esto cada vez, lo meto en el script [`build.sh`](https://github.com/s-nt-s/OpenWrt-Nexx_WT3020F/raw/master/build.sh) que
